    ...
    return (
        <div className={styles.startedContainer} id="gettingStarted">
            ...
            <div className={styles.stepsContainer}>
                ...
                <p className={styles.noteText}>** <strong>Note:</strong> Our app requires your own MongoDB database and Github OAuth setup on Github. Follow steps 2-3 to setup up your MongoDB database and Github OAuth with Aionic. If the setup is already done, continue to step 5.**</p>
